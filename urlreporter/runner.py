...
async def run_scans(
    ...
    *,
    ...
    timeout = httpx.Timeout(connect=10.0, read=read_timeout, write=30.0, pool=read_timeout)
    headers = {"User-Agent": cfg.user_agent}
    # request_hook fires before every outbound HTTP request, including those
    # generated by follow_redirects=True. The web surface uses this to re-check
    # SSRF on redirect targets — without it, a publicly-routable URL that 302s
